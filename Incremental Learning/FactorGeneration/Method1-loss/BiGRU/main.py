...
if __name__ == '__main__':
    ...
    testDataSets = RecurrentAndNeural.getPeriodDataSets(20220104, 20221130, dataSets) #测试集 目前20220104-20221130
    ...
    testIC, testCorr, testMean, testStd = RecurrentAndNeural.calPerformance(testPredictY, YDataSet) #强弱因子合成后的因子的IC
